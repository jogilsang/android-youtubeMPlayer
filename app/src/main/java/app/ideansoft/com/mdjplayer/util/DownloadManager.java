package app.ideansoft.com.mdjplayer.util;
...
import app.ideansoft.com.mdjplayer.activity.YoutubeActivity;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what)
            {
                ...
                case HANDLE_END_DOWNLOAD:
                    ...
                    // 다운로드가 다 되면 유튜브 액티비티로 점프
                    Intent Existed = new Intent(m_oContext, YoutubeActivity.class);
                    m_oContext.startActivity(Existed);
//                    ((DownloadActivity)m_oContext).finish();
